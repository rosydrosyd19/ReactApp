...
import { Edit, Trash2, Plus, Search, MapPin, Eye } from 'lucide-react';
                        ...
                        <tbody className="divide-y divide-gray-100 dark:divide-gray-700">
                            {filteredLocations.map((location) => (
                                <tr key={location.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                    ...
                                    <td className="p-4 text-gray-600 dark:text-gray-300">{location.state || '-'}</td>
                                    <td className="p-4 text-gray-600 dark:text-gray-300">{location.country || '-'}</td>
                                    <td className="p-4">
