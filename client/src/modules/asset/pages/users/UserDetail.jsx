...
import { ArrowLeft, User, Mail, Phone, Briefcase, Building, QrCode } from 'lucide-react';
    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center space-x-4">
                <button
                    onClick={() => authUser ? navigate('/users') : navigate(-1)}
                ...
                <div className="space-y-4">
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6 text-center">
                        ...
                        <div className="bg-white p-4 rounded-xl inline-block mb-4 shadow-sm border border-gray-100">
                            <QRCodeCanvas
                                value={`${window.location.origin}/scan/users/${user.id}`}
                                size={150}
                                level={"H"}
                            />
                        </div>
                        ...
                        <button
                            onClick={() => {
                                ...
                                a.href = url;
                                a.download = `qr-${user.name.replace(/\s+/g, '-').toLowerCase()}.png`;
                                a.click();
                            }}
