...
const BulkQRPrintModal = ({ items, itemType, isOpen, onClose, getItemUrl }) => {
    ...
    const [previewZoom, setPreviewZoom] = useState(0.65); // Default 65% zoom for comfortable view
            ...
            <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-2xl w-full max-w-7xl h-[90vh] flex flex-col overflow-hidden border border-gray-200 dark:border-gray-700">
                ...
                <div className="flex flex-1 overflow-hidden">
                    ...
                    <div className="flex-1 bg-gray-100 dark:bg-gray-900/50 overflow-auto p-8 flex flex-col items-center">
                        {/* Preview Controls */}
                        <div className="mb-4 flex items-center gap-4 bg-white dark:bg-gray-800 px-6 py-3 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
                            ...
                            <div className="flex items-center gap-2 border-l border-gray-200 dark:border-gray-700 pl-4">
                                ...
                                <span className="text-xs font-mono text-gray-700 dark:text-gray-300 min-w-[3rem] text-center">
                                ...
                                <button
                                    ...
                                    className="px-2 py-1 text-xs bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 hover:bg-blue-200 dark:hover:bg-blue-900/50 rounded transition-colors"
                                >
                                    Reset
                                </button>
                            </div>
